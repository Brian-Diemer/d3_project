...
d3.csv("Data.csv", function (err, Data) {
  ...
  Data.forEach(function (data) {
    ...
    data.PercentBingeDrink = +data.PercentBingeDrink;
  });
  ...
  var yLinearScale = d3.scaleLinear()
    .domain([0, d3.max(Data, d => d.PercentBingeDrink)])
    .range([height, 0]);
  ...
  var circlesGroup = chartGroup.selectAll("circle")
    ...
    .attr("cy", d => yLinearScale(d.PercentBingeDrink))
    .attr("r", 10)
    .attr("fill", "steelblue")
    .attr("opacity", ".75")
  ...
  circlesGroup.append("text").text(function(d){
      ...
      .attr("y", function (d) {
        return yLinearScale(d.PercentBingeDrink)
      })
